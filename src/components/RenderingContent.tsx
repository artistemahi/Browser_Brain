  ...
  return (
    <div className="text-black text-start space-y-6">
      <AnimatePresence>
        ...
        >
          <h1 className=" text-blue-200 text-4xl font-bold">What is Rendering?</h1>
          ...
          <h2 className="text-blue-200 text-2xl font-semibold">Types of Rendering</h2>

          <ul className="text-white list-disc pl-6 space-y-2 py-2">
            <li>
