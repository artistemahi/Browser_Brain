...
import { PlayIcon, StopIcon, BackwardStep, ForwardStep } from '../../utils/constants'
import RenderingContent from './RenderingContent'

const RenderingBody = () => {
  return (
    <div><div className="bg-gray-300 min-h-dvh ">
      {/* body section */}
      <div className="bg-green-400 flex justify-evenly min-h-dvh ">
        ...
        {/* main body */}
        <div className="flex-1 bg-fuchsia-50 px-10 text-center"><RenderingContent /></div>
        {/* right pannel */}
